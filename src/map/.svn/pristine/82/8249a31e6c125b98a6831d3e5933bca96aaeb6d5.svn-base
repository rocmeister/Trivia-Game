 ...
 * In general, it is highly recommended that MapLayers NOT be serialized and transmitted.  
 * Rather, the information needed to construct a MapLayer be sent and the MapLayer itself instantiated
...
public class MapLayer extends AnnotationLayer implements Serializable {
	 ...
	 * @throws IOException On errors during stream operations
	 */
	...
	/**
	 * Unique identifier of the MapLayer instance used to compare separately deserialized instances.
	 */
