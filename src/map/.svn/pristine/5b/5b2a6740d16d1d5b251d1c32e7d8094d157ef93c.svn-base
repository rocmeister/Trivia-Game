...
public class DefaultAnnotationAttributes extends AnnotationAttributes implements Serializable {
	...
	/**
	 * The radius of a callout, e.g. an annotation
	 */
	public static final int CORNER_RADIUS = 10;
	/**
	 * The space around the text of a callout
	 */
	public static final Insets INSETS = new Insets(8, 8, 8, 8);
	/**
	 * The background color of a callout
	 */
	public static final Color BACKGROUND_COLOR = new Color(0f, 0f, 0f, .5f);
	/**
	 * The text color of a callout
	 */
	public static final Color TEXT_COLOR = Color.WHITE;
	/**
	 * The minimum scale of an annotation
	 */
	public static final double DISTANCE_MIN_SCALE = 0.5;
	/**
	 * The maximum scale of an annotation
	 */
	public static final double DISTANCE_MAX_SCALE = 2.0;
	/**
	 * The minimum opacity an annotation may have
	 */
	public static final double DISTANCE_MIN_OPACITY = 0.5;
	/**
	 * The length of the leader gap in an annotation, i.e. the size of the callout's tail.
	 */
	public static final int LEADER_GAP_WIDTH =  14;
	/**
	 * The position of a callout with respect to the position to which it is attached.
	 */
	public static final Point DRAW_OFFSET = new Point(20, 40);
	
	/**
	 * Unique class id for Serializable
	 */
	 ...
	 * @throws IOException  On an error during stream operations
	 */
	 ...
	 * @throws IOException  On error during stream operations
	 * @throws ClassNotFoundException If the target class was not found
	 */
	...
	/**
	 * Unique identifier used to compare separately deserialized instances.
	 */
