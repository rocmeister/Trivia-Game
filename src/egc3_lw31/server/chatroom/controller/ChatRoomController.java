package egc3_lw31.server.chatroom.controller;
...
import egc3_lw31.server.chatroom.model.ChatRoomModel;
import egc3_lw31.server.chatroom.model.IChatRoomModel2ViewAdapter;
import egc3_lw31.server.chatroom.model.IMini2MainAdapter;
import egc3_lw31.server.chatroom.view.ChatRoomView;
import egc3_lw31.server.chatroom.view.IChatRoomView2ModelAdapter;
...
public class ChatRoomController {
	 ...
	 */
	public ChatRoomController(IGroup room, IRemoteConnection userStub, IMini2MainAdapter m2MAdpt) {
...
//			}
		...
		roomModel = new ChatRoomModel(room, m2MAdpt, userStub, new IChatRoomModel2ViewAdapter() {
			...
			public IGroup createTeamRoom(String name, List<IRemoteConnection> members) {
				return m2MAdpt.createTeamRoom(name, members);
			}
		});
	}
